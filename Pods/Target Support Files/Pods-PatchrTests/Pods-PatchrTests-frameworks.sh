...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-PatchrTests/AirPhotoBrowser.framework"
  ...
  install_framework "Pods-PatchrTests/Parse.framework"
  ...
  install_framework "Pods-PatchrTests/ZOZolaZoomTransition.framework"
