...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/NHBalancedFlowLayout/NHBalancedFlowLayout.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/THContactPicker/THContactPicker.framework"
