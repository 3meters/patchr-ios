...
class InstantSearchViewController: UITableViewController {
...
extension InstantSearchViewController: UISearchBarDelegate {
    ...
    func searchBar(searchBar: UISearchBar, textDidChange searchText: String) {
        self.searchEditing = (searchText.length > 0)
        if searchText.length >= 2 {
            ...
            self.searchTimer = NSTimer(timeInterval:0.5, target:self, selector:Selector("search"), userInfo:nil, repeats:false)
...
extension InstantSearchViewController: UISearchDisplayDelegate {
    ...
    func searchDisplayController(controller: UISearchDisplayController, didShowSearchResultsTableView tableView: UITableView) {
        ...
        let newFrame = CGRectMake(frame.origin.x, frame.origin.y, frame.size.width, 0)
        tableView.frame = newFrame
    }
}

extension InstantSearchViewController: UITableViewDelegate {
