...
class ZInviteViewController: BaseViewController {
    ...
    *--------------------------------------------------------------------------------------------*/
	...
	override func initialize() {
		...
		self.invitePatchrButton.addTarget(self, action: #selector(invitePatchrAction(sender:)), for: .touchUpInside)
		self.inviteFacebookButton.addTarget(self, action: #selector(inviteFacebookAction(sender:)), for: .touchUpInside)
		self.inviteViaButton.addTarget(self, action: #selector(inviteViaAction(sender:)), for: .touchUpInside)
		...
		let submitButton = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.done, target: self, action: #selector(doneAction(sender:)))
