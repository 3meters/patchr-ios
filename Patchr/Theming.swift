...
class Snow {
    ...
    let colorBackgroundCell             = Colors.gray90pcntColor
    ...
    let fontTextListItalic      : UIFont! = UIFont(name: "HelveticaNeue-LightItalic", size: 17)
...
public struct Colors {
    ...
    static let opacity25pcntBlack: UIColor = UIColor(red: CGFloat(0), green: CGFloat(0), blue: CGFloat(0), alpha: CGFloat(0.25))
